...
#' @param value.method boxcox (scaled tukey, \code{\link[car]{bcPower}} for all positive, \code{\link[car]{bcnPower}} for any non-positive--ie, zero or negative) or modified tukey (I modified \code{\link[car]{basicPower}}), both methods keep the ordering.
