...
#'
#' @return See Pallier (2002) for the algorithms.
#'
...
#'  \item{\strong{bppd (B''D)}: }{Non-parametric estimate of bias. A B''D ranges from 􏰁1 (extreme bias in favor of yes/liberal responses) to 1 (extreme bias in favor of no/conservative responses). A value of 0 signifies no response bias.}
...
#'
#'
#' @author Jerry modified from \href{https://dominiquemakowski.github.io/}{Dominique Makowski}
#'
