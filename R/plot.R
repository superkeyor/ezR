...
#' \cr see http://stackoverflow.com/a/31437048/2292993 for discussion
#' @export
ez.countplot = function(df,cmd,position='both',color='color',colors=ez.palette("Zhu"),alpha=1,title.size=20,n.size=5.5,n.angle=0,n.type=3,width=0.7,ylab=NULL,xlab=NULL,zlab=NULL,legend.position='top',legend.direction="horizontal",legend.box=T,legend.size=c(0,10),facet='cols',theme.apa=TRUE) {
    df.bak=df
    if (position=='both') {
        p1=ez.countplot(df,cmd,'stack',color, colors, alpha, title.size, n.size, n.angle, n.type, width, ylab, xlab, zlab, legend.position, legend.direction, legend.box, legend.size, facet, theme.apa)
        p2=ez.countplot(df,cmd,'fill',color, colors, alpha, title.size, n.size, n.angle, n.type, width, ylab, xlab, zlab, legend.position, legend.direction, legend.box, legend.size, facet, theme.apa)
...
ez.piechart = function(df,cmd,start=0,direction=1,color='color',colors=ez.palette("Zhu"),alpha=1,n.size=5.5,n.type=3,n.angle=0,ylab='',xlab='',zlab=NULL,legend.position='top',legend.direction="horizontal",legend.box=T,legend.size=c(0,10),xangle=0,vjust=NULL,hjust=NULL,theme.apa=TRUE) {
    ...
    pp = ggplot2::ggplot(dfdf, aes(x="",n,fill=%s)) +
                 ...
                 , xx, alpha, color, ylab, xlab, zlab, legend.position, legend.box, legend.direction, legend.size[1], legend.size[2], legend.size[2], n.size, n.angle, n.type.fill, start, direction
    )
    gghistory=paste(gghistory,
